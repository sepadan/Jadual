...
| **Ambil senarai guru** | Menyelaraskan senarai guru pembina dengan senarai guru rasmi dalam tab **Guru**, termasuk pautan guru gantian (Personel MySTEP / Guru Praktikal). Penyelarasan ini juga berlaku **secara automatik setiap kali log masuk**, jadi butang ini jarang diperlukan. |
| **Guna draf peranti** | Muncul **hanya apabila** peranti ini menyimpan kerja yang belum naik ke Sheets semasa log masuk. Menekannya mengembalikan kerja itu sebagai draf hidup (draf Sheets pada skrin digantikan) supaya tuan boleh **Simpan draf ke Sheets**. |
...
Cara membaca kad ini: draf pembina disimpan **pada peranti** semasa tuan bekerja, jadi menutup pelayar tidak menghilangkannya. Setiap kali tuan **log masuk** dan membuka **Bina dan urus jadual**, aplikasi memuatkan **draf Sheets sendiri** — tuan tidak perlu menekan apa-apa. **Simpan draf ke Sheets** ialah satu-satunya cara draf itu selamat melepasi peranti itu (telefon hilang, tukar komputer, atau dibuka oleh pentadbir lain) — ia **tidak** berlaku secara automatik. **Muat draf Sheets** jarang diperlukan kerana draf Sheets sudah dimuatkan sendiri semasa log masuk; gunakannya jika pentadbir lain mengubah draf di tempat lain. **Ambil senarai guru** perlu selepas tuan menambah atau menukar nama guru di tab **Guru** (penyelarasan automatik hanya berlaku apabila pembina masih belum ada guru). **Gunakan untuk relief** wajib dan tidak boleh dibuang — tanpanya jadual yang dibina tidak menjadi jadual rasmi yang digunakan oleh relief.

Jika peranti ini masih menyimpan kerja yang belum dinaikkan ke Sheets, **draf Sheets tetap dimuatkan** (ia sumber rasmi) dan kerja peranti itu **disimpan di sebelah, bukan dibuang**: baris status menulis **"Draf Sheets dimuatkan · kerja lama pada peranti disimpan"** dan butang **Guna draf peranti** muncul. Tekan butang itu untuk memakai kerja peranti tersebut, kemudian **Simpan draf ke Sheets**. **Muat draf Sheets** jarang diperlukan sekarang — ia hanya untuk menarik semula salinan awan dalam sesi yang sedang berjalan. Apabila storan peranti penuh (atau pelayar berada dalam mod peribadi), pil draf bertukar **"Storan peranti penuh"** — eksport JSON sebelum menutup aplikasi, kerana perubahan seterusnya hanya kekal selagi tab dibuka.
...
Butang **"Jana jadual gantian"** di bawah panel Jana Jadual hanya diperlukan untuk draf lama yang dibina sebelum gantian automatik: ia **memindahkan** pemilikan slot kepada Personel MySTEP (bukan menyalin baris), atau menambah guru Praktikal sebagai pasangan. Menekannya berulang kali tidak menambah kiraan.
...
3. Jika butang **Guna draf peranti** muncul pada kad Draf, bermakna peranti ini masih menyimpan kerja yang belum naik ke Sheets — putuskan dahulu sama ada mahu memakainya (tekan butang itu → **Simpan draf ke Sheets**) atau mengabaikannya. Jangan terus terbitkan tanpa memutuskan.
...
| **3.1.45** | **Draf Sheets dimuatkan sendiri setiap kali log masuk** (tidak perlu tekan "Muat draf Sheets" lagi); senarai guru diselaraskan automatik; kerja peranti yang belum naik ke Sheets disimpan dan boleh diambil semula dengan butang **Guna draf peranti**. |
