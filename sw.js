...
const APP_SHELL = [
  ...
  "./app.js?v=3.1.69",
  "./builder.js?v=3.1.69",
  "./builder.css?v=3.1.69",
  "./workspace.css?v=3.1.69",
  "./builder-relief.js?v=3.1.69",
  "./admin-api.js?v=3.1.69",
  "./site-config.js?v=3.1.69",
  "./public-ui.css?v=3.1.69",
  "./data.js?v=3.1.69",
  "./relief-engine.js?v=3.1.69",
  "./setting-slots.js?v=3.1.69",
  "./week-view.js?v=3.1.69",
  "./pdf-import.js?v=3.1.69",
  "./pdf-builder.js?v=3.1.69",
  "./teacher-transfer.js?v=3.1.69",
  "./teacher-coverage.js?v=3.1.69",
  "./relief-print.js?v=3.1.69",
  "./relief-pdf.js?v=3.1.69",
