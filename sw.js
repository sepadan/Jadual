...
const APP_SHELL = [
  ...
  "./builder.js?v=3.0.2",
  "./builder.css?v=3.0.2",
  "./workspace.css?v=3.0.2",
  "./builder-relief.js?v=3.0.2",
  "./admin-api.js?v=3.0.2",
  "./site-config.js?v=3.0.2",
  "./public-ui.css?v=3.0.2",
  "./data.js?v=3.0.2",
  "./relief-engine.js?v=3.0.2",
  "./pdf-import.js?v=3.0.2",
  "./pdf-builder.js?v=3.0.2",
  "./teacher-transfer.js?v=3.0.2",
