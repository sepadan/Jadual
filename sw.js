...
const APP_SHELL = [
  ...
  "./builder.js?v=3.0.1",
  "./builder.css?v=3.0.1",
  "./workspace.css?v=3.0.1",
  "./builder-relief.js?v=3.0.1",
  "./admin-api.js?v=3.0.1",
  "./site-config.js?v=3.0.1",
  "./public-ui.css?v=3.0.1",
  "./data.js?v=3.0.1",
  "./relief-engine.js?v=3.0.1",
  "./pdf-import.js?v=3.0.1",
  "./pdf-builder.js?v=3.0.1",
