...
const APP_SHELL = [
  ...
  "./builder.js?v=3.0.0",
  "./builder.css?v=3.0.0",
  "./workspace.css?v=3.0.0",
  "./builder-relief.js?v=3.0.0",
  "./admin-api.js?v=3.0.0",
  "./site-config.js?v=3.0.0",
  "./public-ui.css?v=3.0.0",
  "./data.js?v=3.0.0",
  "./relief-engine.js?v=3.0.0",
  "./pdf-import.js?v=3.0.0",
  "./pdf-builder.js?v=3.0.0",
