...
const APP_SHELL = [
  ...
  "./app.js?v=3.1.66",
  "./builder.js?v=3.1.66",
  "./builder.css?v=3.1.66",
  "./workspace.css?v=3.1.66",
  "./builder-relief.js?v=3.1.66",
  "./admin-api.js?v=3.1.66",
  "./site-config.js?v=3.1.66",
  "./public-ui.css?v=3.1.66",
  "./data.js?v=3.1.66",
  "./relief-engine.js?v=3.1.66",
  "./setting-slots.js?v=3.1.66",
  "./week-view.js?v=3.1.66",
  "./pdf-import.js?v=3.1.66",
  "./pdf-builder.js?v=3.1.66",
  "./teacher-transfer.js?v=3.1.66",
  "./teacher-coverage.js?v=3.1.66",
  "./relief-print.js?v=3.1.66",
  "./relief-pdf.js?v=3.1.66",
