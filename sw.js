...
const APP_SHELL = [
  ...
  "./app.js?v=3.1.74",
  "./builder.js?v=3.1.74",
  "./builder.css?v=3.1.74",
  "./workspace.css?v=3.1.74",
  "./builder-relief.js?v=3.1.74",
  "./admin-api.js?v=3.1.74",
  "./site-config.js?v=3.1.74",
  "./public-ui.css?v=3.1.74",
  "./data.js?v=3.1.74",
  "./relief-engine.js?v=3.1.74",
  "./setting-slots.js?v=3.1.74",
  "./week-view.js?v=3.1.74",
  "./pdf-import.js?v=3.1.74",
  "./pdf-builder.js?v=3.1.74",
  "./teacher-transfer.js?v=3.1.74",
  "./teacher-coverage.js?v=3.1.74",
  "./relief-print.js?v=3.1.74",
  "./relief-pdf.js?v=3.1.74",
