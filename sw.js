...
const APP_SHELL = [
  ...
  "./builder.js?v=3.0.6",
  "./builder.css?v=3.0.6",
  "./workspace.css?v=3.0.6",
  "./builder-relief.js?v=3.0.6",
  "./admin-api.js?v=3.0.6",
  "./site-config.js?v=3.0.6",
  "./public-ui.css?v=3.0.6",
  "./data.js?v=3.0.6",
  "./relief-engine.js?v=3.0.6",
  "./pdf-import.js?v=3.0.6",
  "./pdf-builder.js?v=3.0.6",
  "./teacher-transfer.js?v=3.0.6",
