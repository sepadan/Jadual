...
const APP_SHELL = [
  ...
  "./app.js?v=3.1.71",
  "./builder.js?v=3.1.71",
  "./builder.css?v=3.1.71",
  "./workspace.css?v=3.1.71",
  "./builder-relief.js?v=3.1.71",
  "./admin-api.js?v=3.1.71",
  "./site-config.js?v=3.1.71",
  "./public-ui.css?v=3.1.71",
  "./data.js?v=3.1.71",
  "./relief-engine.js?v=3.1.71",
  "./setting-slots.js?v=3.1.71",
  "./week-view.js?v=3.1.71",
  "./pdf-import.js?v=3.1.71",
  "./pdf-builder.js?v=3.1.71",
  "./teacher-transfer.js?v=3.1.71",
  "./teacher-coverage.js?v=3.1.71",
  "./relief-print.js?v=3.1.71",
  "./relief-pdf.js?v=3.1.71",
