...
const APP_SHELL = [
  ...
  "./builder.js?v=3.0.5",
  "./builder.css?v=3.0.5",
  "./workspace.css?v=3.0.5",
  "./builder-relief.js?v=3.0.5",
  "./admin-api.js?v=3.0.5",
  "./site-config.js?v=3.0.5",
  "./public-ui.css?v=3.0.5",
  "./data.js?v=3.0.5",
  "./relief-engine.js?v=3.0.5",
  "./pdf-import.js?v=3.0.5",
  "./pdf-builder.js?v=3.0.5",
  "./teacher-transfer.js?v=3.0.5",
