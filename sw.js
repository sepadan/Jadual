...
const APP_SHELL = [
  ...
  "./app.js?v=3.1.64",
  "./builder.js?v=3.1.64",
  "./builder.css?v=3.1.64",
  "./workspace.css?v=3.1.64",
  "./builder-relief.js?v=3.1.64",
  "./admin-api.js?v=3.1.64",
  "./site-config.js?v=3.1.64",
  "./public-ui.css?v=3.1.64",
  "./data.js?v=3.1.64",
  "./relief-engine.js?v=3.1.64",
  "./setting-slots.js?v=3.1.64",
  "./week-view.js?v=3.1.64",
  "./pdf-import.js?v=3.1.64",
  "./pdf-builder.js?v=3.1.64",
  "./teacher-transfer.js?v=3.1.64",
  "./teacher-coverage.js?v=3.1.64",
  "./relief-print.js?v=3.1.64",
  "./relief-pdf.js?v=3.1.64",
