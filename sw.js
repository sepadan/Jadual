...
const APP_SHELL = [
  ...
  "./app.js?v=3.1.77",
  "./builder.js?v=3.1.77",
  "./builder.css?v=3.1.77",
  "./workspace.css?v=3.1.77",
  "./builder-relief.js?v=3.1.77",
  "./admin-api.js?v=3.1.77",
  "./site-config.js?v=3.1.77",
  "./public-ui.css?v=3.1.77",
  "./data.js?v=3.1.77",
  "./relief-engine.js?v=3.1.77",
  "./setting-slots.js?v=3.1.77",
  "./week-view.js?v=3.1.77",
  "./pdf-import.js?v=3.1.77",
  "./pdf-builder.js?v=3.1.77",
  "./teacher-transfer.js?v=3.1.77",
  "./teacher-coverage.js?v=3.1.77",
  "./relief-print.js?v=3.1.77",
  "./relief-pdf.js?v=3.1.77",
