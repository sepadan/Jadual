...
const APP_SHELL = [
  ...
  "./app.js?v=3.1.68",
  "./builder.js?v=3.1.68",
  "./builder.css?v=3.1.68",
  "./workspace.css?v=3.1.68",
  "./builder-relief.js?v=3.1.68",
  "./admin-api.js?v=3.1.68",
  "./site-config.js?v=3.1.68",
  "./public-ui.css?v=3.1.68",
  "./data.js?v=3.1.68",
  "./relief-engine.js?v=3.1.68",
  "./setting-slots.js?v=3.1.68",
  "./week-view.js?v=3.1.68",
  "./pdf-import.js?v=3.1.68",
  "./pdf-builder.js?v=3.1.68",
  "./teacher-transfer.js?v=3.1.68",
  "./teacher-coverage.js?v=3.1.68",
  "./relief-print.js?v=3.1.68",
  "./relief-pdf.js?v=3.1.68",
