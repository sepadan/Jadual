...
const APP_SHELL = [
  ...
  "./app.js?v=3.1.73",
  "./builder.js?v=3.1.73",
  "./builder.css?v=3.1.73",
  "./workspace.css?v=3.1.73",
  "./builder-relief.js?v=3.1.73",
  "./admin-api.js?v=3.1.73",
  "./site-config.js?v=3.1.73",
  "./public-ui.css?v=3.1.73",
  "./data.js?v=3.1.73",
  "./relief-engine.js?v=3.1.73",
  "./setting-slots.js?v=3.1.73",
  "./week-view.js?v=3.1.73",
  "./pdf-import.js?v=3.1.73",
  "./pdf-builder.js?v=3.1.73",
  "./teacher-transfer.js?v=3.1.73",
  "./teacher-coverage.js?v=3.1.73",
  "./relief-print.js?v=3.1.73",
  "./relief-pdf.js?v=3.1.73",
