...
const APP_SHELL = [
  ...
  "./builder.js?v=3.0.7",
  "./builder.css?v=3.0.7",
  "./workspace.css?v=3.0.7",
  "./builder-relief.js?v=3.0.7",
  "./admin-api.js?v=3.0.7",
  "./site-config.js?v=3.0.7",
  "./public-ui.css?v=3.0.7",
  "./data.js?v=3.0.7",
  "./relief-engine.js?v=3.0.7",
  "./pdf-import.js?v=3.0.7",
  "./pdf-builder.js?v=3.0.7",
  "./teacher-transfer.js?v=3.0.7",
