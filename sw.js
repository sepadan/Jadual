...
const APP_SHELL = [
  ...
  "./builder.js?v=3.0.3",
  "./builder.css?v=3.0.3",
  "./workspace.css?v=3.0.3",
  "./builder-relief.js?v=3.0.3",
  "./admin-api.js?v=3.0.3",
  "./site-config.js?v=3.0.3",
  "./public-ui.css?v=3.0.3",
  "./data.js?v=3.0.3",
  "./relief-engine.js?v=3.0.3",
  "./pdf-import.js?v=3.0.3",
  "./pdf-builder.js?v=3.0.3",
  "./teacher-transfer.js?v=3.0.3",
