...
const APP_SHELL = [
  ...
  "./app.js?v=3.1.70",
  "./builder.js?v=3.1.70",
  "./builder.css?v=3.1.70",
  "./workspace.css?v=3.1.70",
  "./builder-relief.js?v=3.1.70",
  "./admin-api.js?v=3.1.70",
  "./site-config.js?v=3.1.70",
  "./public-ui.css?v=3.1.70",
  "./data.js?v=3.1.70",
  "./relief-engine.js?v=3.1.70",
  "./setting-slots.js?v=3.1.70",
  "./week-view.js?v=3.1.70",
  "./pdf-import.js?v=3.1.70",
  "./pdf-builder.js?v=3.1.70",
  "./teacher-transfer.js?v=3.1.70",
  "./teacher-coverage.js?v=3.1.70",
  "./relief-print.js?v=3.1.70",
  "./relief-pdf.js?v=3.1.70",
