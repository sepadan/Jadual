...
const APP_SHELL = [
  ...
  "./builder.js?v=3.0.4",
  "./builder.css?v=3.0.4",
  "./workspace.css?v=3.0.4",
  "./builder-relief.js?v=3.0.4",
  "./admin-api.js?v=3.0.4",
  "./site-config.js?v=3.0.4",
  "./public-ui.css?v=3.0.4",
  "./data.js?v=3.0.4",
  "./relief-engine.js?v=3.0.4",
  "./pdf-import.js?v=3.0.4",
  "./pdf-builder.js?v=3.0.4",
  "./teacher-transfer.js?v=3.0.4",
