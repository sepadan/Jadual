...
const APP_SHELL = [
  ...
  "./app.js?v=3.1.78",
  "./builder.js?v=3.1.78",
  "./builder.css?v=3.1.78",
  "./workspace.css?v=3.1.78",
  "./builder-relief.js?v=3.1.78",
  "./admin-api.js?v=3.1.78",
  "./site-config.js?v=3.1.78",
  "./public-ui.css?v=3.1.78",
  "./data.js?v=3.1.78",
  "./relief-engine.js?v=3.1.78",
  "./setting-slots.js?v=3.1.78",
  "./week-view.js?v=3.1.78",
  "./pdf-import.js?v=3.1.78",
  "./pdf-builder.js?v=3.1.78",
  "./teacher-transfer.js?v=3.1.78",
  "./teacher-coverage.js?v=3.1.78",
  "./relief-print.js?v=3.1.78",
  "./relief-pdf.js?v=3.1.78",
