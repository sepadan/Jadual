import { APP_VERSION, DAY_NAMES, PERIODS, emptyDatabase, slug } from "./data.js?v=3.1.9";
import { ApiClient, loadConfig, saveConfig } from "./admin-api.js?v=3.1.9";
import { activeScheduleRows, buildReliefDrafts, cancelAbsenceAndReliefs, cancelReliefsAssignedToAbsence, dayCodeFromDate, reliefHasActiveAbsence, reliefMatchesAbsence, validateReliefs, dailyReliefLimit, selectedScheduleVersion, officialScheduleVersion } from "./relief-engine.js?v=3.1.9";
import { buildImportSelection, parseTeacherPdf } from "./pdf-import.js?v=3.1.9";
import { convertBuilderSchedule } from "./builder-relief.js?v=3.1.9";
import { draftFromPdf } from './pdf-builder.js?v=3.1.9';
import { exportTeachers, importTeachers } from './teacher-transfer.js?v=3.1.9';
import { buildReliefPrintModel, reliefPrintHtml } from './relief-print.js?v=3.1.9';
import { openReliefPdf } from './relief-pdf.js?v=3.1.9';
